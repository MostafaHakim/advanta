...
interface Blog extends BlogForm {
  _id: string;
  createdAt: string;
  updatedAt: string;
}
      ...
      try {
        ...
        if (data.success && data.data) {
          ...
          setForm({
            ...
            published: blog.published !== false, // default to true
          });
        } else {
          setMessage({
            type: "error",
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="border border-gray-200 rounded-xl overflow-hidden">
                        <div className="bg-gray-50 border-b border-gray-200 p-3 flex items-center gap-1 flex-wrap">
                          <button
                            type="button"
                            onClick={() => formatText("h1")}
                            className="w-8 h-8 rounded-lg bg-white border border-gray-200 flex items-center justify-center hover:bg-blue-50 hover:border-blue-300 transition-colors"
                            title="Heading 1"
                          >
                        ...
                        <textarea
                          ref={contentRef}
                          name="content"
                          placeholder="Write your blog content here... Select text and use the toolbar above to format with H1, H2, bold, italic, etc."
                          value={form.content}
                          onChange={handleChange}
                          required
                          rows={12}
                          className="w-full px-4 py-3 outline-none resize-none bg-white font-mono"
                        />
                      </div>
                      
                      <div className="text-xs text-gray-500 flex justify-between">
                        <span>
                          Select text and click H1, H2 buttons to format headings
                        </span>

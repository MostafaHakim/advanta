...
export default function ContactSettingsForm() {
  ...
  const updateSocialUrl = (platform: keyof SocialUrls, value: string) => {
    setData({
      ...data,
      socialUrl: {
        ...data.socialUrl,
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Manage your contact information, departments, social media, and
                address details
              </p>
            </div>
            <div className="flex gap-3">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex flex-wrap gap-4">
                {SOCIAL_PLATFORMS.map((platform) => {
                  const url = data.socialUrl[platform.key as keyof SocialUrls];
                  if (!url) return null;
                  ...
                  return (
                    <a
                      ...
                      className="flex items-center gap-3 bg-gradient-to-br from-gray-50 to-white rounded-xl px-6 py-3 border border-gray-200 hover:shadow-lg transition-all hover:-translate-y-1"
                    >
                ...
                {Object.values(data.socialUrl).every((v) => !v) && (
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {SOCIAL_PLATFORMS.map((platform) => {
                  const IconComponent = platform.icon;
                  const value =
                    data.socialUrl[platform.key as keyof SocialUrls];
                  return (
                    <div
                      key={platform.key}
                      className="border border-gray-200 rounded-xl p-6 hover:border-blue-300 transition-all"
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateSocialUrl(
                              platform.key as keyof SocialUrls,
                              e.target.value,
                            )
                          }

...
const ServicesSection = () => {
  return (
    <section className="relative section-padding overflow-hidden ">
      ...
      {/* Glow Effects */}
      <div className="absolute top-32 left-20 w-72 h-72 bg-blue-600/20 blur-3xl rounded-full" />
      <div className="absolute bottom-32 right-20 w-72 h-72 bg-purple-600/20 blur-3xl rounded-full" />
      ...
      <div className="container-custom relative z-10">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              >
                {/* Icon */}
                <div
                  className={`w-12 h-12 md:w-16 md:h-16 rounded-2xl mb-6
        ...
        >
          <Link
            href="/services"
            className="
              inline-flex items-center px-8 py-4 rounded-xl font-semibold text-white

...
//   return (
//     <section className="relative py-24 lg:py-32 overflow-hidden bg-gradient-to-br from-[#218c74] via-[#1e7a64] to-[#33d9b2]">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Card */}
              <div className="relative bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden border border-white/20 transition-all duration-500">
                {/* Image Container */}
                <div className="relative pt-8 px-6">
                  <div className="relative w-40 h-40 mx-auto">
                    {/* Animated Ring */}
